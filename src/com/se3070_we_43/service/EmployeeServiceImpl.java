...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void createEmployeeTable() {
        try {
            ...
            // SelectQuery.xml
            statement.executeUpdate(QueryUtil.SelectQuery(Constants.QUERY_ID_DROP_EMPLOYEE_TABLE));
            // Create new employee table as per SQL query available in
            // SelectQuery.xml
            statement.executeUpdate(QueryUtil.SelectQuery(Constants.QUERY_ID_CREATE_EMPLOYEE_TABLE));
    ...
    /**
     * Creates the data read from xml file.
     */
    @Override
    ...
    public void addEmployee() {
        try {
            preparedStatement = connection.prepareStatement(QueryUtil.SelectQuery(Constants.QUERY_ID_INSERT_EMPLOYEES));
    ...
    public void getEmployees() {
        ...
        try {
            preparedStatement = connection.prepareStatement(QueryUtil.SelectQuery(Constants.QUERY_ID_ALL_EMPLOYEES));
    ...
    public void getEmployeeByID(String id) {
        Employee employee = new Employee();
        try {
            preparedStatement = connection.prepareStatement(QueryUtil.SelectQuery(Constants.QUERY_ID_GET_EMPLOYEE));
    ...
    public void removeEmployee(String id) {
        try {
            preparedStatement = connection.prepareStatement(QueryUtil.SelectQuery(Constants.QUERY_ID_REMOVE_EMPLOYEE));
            preparedStatement.setString(1, id);
